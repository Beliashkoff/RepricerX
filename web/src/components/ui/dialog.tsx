...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-6 top-6 rounded-full p-1.5 text-[#666] hover:bg-[#f5f5f5] transition-colors">
        <X className="h-4 w-4" />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title ref={ref} className={cn('text-xl font-semibold text-[#111]', className)} {...props} />
))
